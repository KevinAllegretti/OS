...
module TSOS {
    ...
    export class DeviceDriverDiskSystem extends DeviceDriver {
        ...
        public findFreeBlock(startingTrack){
        ...
        public findFileLocation(filename){
